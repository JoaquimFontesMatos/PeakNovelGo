...
const (
	...
	INVALID_NOVEL_UPDATES_ID = "INVALID_NOVEL_UPDATES_ID"

	// LatestChapter errors
	INVALID_LATEST_CHAPTER = "INVALID_LATEST_CHAPTER"

	// Novel errors
	NOVEL_NOT_FOUND        = "NOVEL_NOT_FOUND"
	NOVEL_ALREADY_IMPORTED = "NOVEL_ALREADY_IMPORTED"
	NOVEL_CONFLICT         = "NOVEL_CONFLICT"
	NO_NOVELS              = "NO_NOVELS"
	IMPORTING_NOVEL        = "IMPORTING_NOVEL"
	GETTING_NOVELS         = "GETTING_NOVELS"
	GETTING_NOVEL          = "GETTING_NOVEL"
	GETTING_TOTAL_NOVELS   = "GETTING_TOTAL_NOVELS"
)

...
func TestHandleRegister(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedCode:        http.StatusBadRequest,
			expectedBody:        `{"error":"Invalid JSON"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}, {"username": "joao", "bio": "bio", "profile_picture": "profile_pic", "date_of_birth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, strings.Repeat("a", 256)),
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, strings.Repeat("a", 255)),
		...
		},
		{
			...
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "%s", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, "joao", strings.Repeat("a", 501)),
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "%s", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, "joao", strings.Repeat("a", 500)),
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
		...
		},
		{
			...
			expectedCode:        http.StatusBadRequest,
			expectedBody:        `{"error":"Failed to bind JSON"}`,
			requestBody:         `{"username": "joao", "bio": "", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         `{"username": "joao", "bio": "b", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "b",
		...
		},
		{
			...
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "%s", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, "joao", strings.Repeat("a", 256)),
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "%s", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`, "joao", strings.Repeat("a", 255)),
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "p", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2008-01-01", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2006-01-01", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2000-01-01", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusBadRequest,
			expectedBody:        `{"error":"You must be at least 18 years old"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2027-01-01", "email": "joao@gmail.com", "password": "12345678"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "%s@a.a", "password": "12345678"}`, "joao", strings.Repeat("a", 252)),
			username:            "joao",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "%s@gmail.com", "password": "12345678"}`, "joao", strings.Repeat("a", 245)),
			username:            "joao",
		...
		},
		{
			...
			expectedCode:        http.StatusBadRequest,
			expectedBody:        `{"error":"Failed to bind JSON"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "", "password": "12345678"}`,
			username:            "joao",
			email:               "",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "a@a.co", "password": "12345678"}`,
			username:            "joao",
			email:               "a@a.co",
			password:            "12345678",
			bio:                 "bio",
		...
		},
		{
			...
			requestBody:         `{"username": "joao", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "1234567"}`,
			username:            "joao",
			email:               "joao@gmail.com",
			password:            "1234567",
			bio:                 "bio",
		...
		},
		{
			...
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "%s"}`, "joao", strings.Repeat("a", 73)),
			username:            "joao",
			email:               "joao@gmail.com",
		...
		},
		{
			...
			expectedCode:        http.StatusCreated,
			expectedBody:        `{"message":"User registered successfully"}`,
			requestBody:         fmt.Sprintf(`{"username": "%s", "bio": "bio", "profilePicture": "profile_pic", "dateOfBirth": "2004-12-23", "email": "joao@gmail.com", "password": "%s"}`, "joao", strings.Repeat("a", 72)),
			username:            "joao",
			email:               "joao@gmail.com",

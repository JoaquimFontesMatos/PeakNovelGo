...
<template>
    <div class="fixed top-2 right-2 z-50 flex w-2/3 flex-col gap-2 md:top-4 md:right-4 md:w-96 md:gap-4">
        <div
            v-for="toast in toasts"
            :key="toast.id"
            :class="[
                'rounded-sm p-2 shadow-sm outline-2 outline-offset-[-5px] outline-accent-gold-dark transition-opacity duration-300 md:p-4',

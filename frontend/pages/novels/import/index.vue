...
<template>
    <Container>
        ...
        <div>
            ...
            <!-- Import Button -->
            <MainButton :disabled="importingNovel" @click="onSubmit" class="w-full md:w-auto">
        ...
        <section v-if="novel" class="space-y-4">
            ...
            <div class="space-y-2">
                <div v-if="showPreview" class="space-y-2 rounded-lg border-border bg-secondary p-4">
                    <p>
                        <span class="font-medium">Novel ID:</span>
                        {{ novel.ID }}
                    </p>
                    <p>
                    ...
                    <p>
                        <span class="font-medium">Synopsis:</span>
                        {{ novel.synopsis }}
                    </p>
                    <p>
                        <span class="font-medium">Cover URL:</span>
                        {{ novel.coverUrl }}
                    </p>
                    <p>
                    ...
                    <p>
                        <span class="font-medium">Novel Updates URL:</span>
                    ...
                    <p>
                        <span class="font-medium">Release Frequency:</span>
                        {{ novel.releaseFrequency }}
                    </p>
                    <p>
                        <span class="font-medium">Novel Updates ID:</span>
                        {{ novel.novelUpdatesId }}
                    </p>
                    <p>
                        <span class="font-medium">Latest Chapter:</span>
                        {{ novel.latestChapter }}
                    </p>
                </div>
            </div>
